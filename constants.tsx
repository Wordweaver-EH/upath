...
import { 
  ...
  P1_2_COARSE_PHASE_TAGGING_CONFIG, 
  P1_3_INTRA_PHASE_SORTING_CONFIG,
  P1_4_DIACHRONIC_UNIT_GROUPING_CONFIG, 
  P1_5_CONSTRUCT_SPECIFIC_DIACHRONIC_STRUCTURE_CONFIG 
} from './src/config/pipeline/part1';
import {
  P2S_1_GROUP_UTTERANCES_BY_TOPIC_CONFIG,
  P2S_2_IDENTIFY_SPECIFIC_SYNCHRONIC_UNITS_CONFIG,
  P2S_3_DEFINE_SPECIFIC_SYNCHRONIC_STRUCTURE_CONFIG,
  P2S_4_SUMMARY_TABLE_CONFIG
} from './src/config/pipeline/part2';
...
export const STEP_CONFIGS: ConfigMap = {
  [StepId.P_NEG1_1_VARIABLE_IDENTIFICATION]: P_NEG1_1_VARIABLE_IDENTIFICATION_CONFIG,
  [StepId.P0_1_TRANSCRIPTION_ADHERENCE]: P0_1_TRANSCRIPTION_ADHERENCE_CONFIG,
  [StepId.P0_2_REFINE_DATA_TYPES]: P0_2_REFINE_DATA_TYPES_CONFIG,
  ...
  [StepId.P1_2_COARSE_PHASE_TAGGING]: P1_2_COARSE_PHASE_TAGGING_CONFIG,
  [StepId.P1_3_INTRA_PHASE_SORTING]: P1_3_INTRA_PHASE_SORTING_CONFIG,
  [StepId.P1_4_DIACHRONIC_UNIT_GROUPING]: P1_4_DIACHRONIC_UNIT_GROUPING_CONFIG,
  [StepId.P1_5_CONSTRUCT_SPECIFIC_DIACHRONIC_STRUCTURE]: P1_5_CONSTRUCT_SPECIFIC_DIACHRONIC_STRUCTURE_CONFIG,
  [StepId.P2S_1_GROUP_UTTERANCES_BY_TOPIC]: P2S_1_GROUP_UTTERANCES_BY_TOPIC_CONFIG,
  [StepId.P2S_2_IDENTIFY_SPECIFIC_SYNCHRONIC_UNITS]: P2S_2_IDENTIFY_SPECIFIC_SYNCHRONIC_UNITS_CONFIG,
  [StepId.P2S_3_DEFINE_SPECIFIC_SYNCHRONIC_STRUCTURE]: P2S_3_DEFINE_SPECIFIC_SYNCHRONIC_STRUCTURE_CONFIG,
  [StepId.P2S_4_SUMMARY_TABLE]: P2S_4_SUMMARY_TABLE_CONFIG,
