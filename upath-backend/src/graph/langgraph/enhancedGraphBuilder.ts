...
/**
 * Enhanced µ-PATH LangGraph pipeline with proper loop logic
 */
export function buildEnhancedUPathGraph() {
...
/**
 * Create enhanced pipeline with loops
 */
export function createEnhancedUPathPipeline() {
  return buildEnhancedUPathGraph();
}