...
interface HilModalZustandProps {
  onSubmit: () => void;
...
const HilModalZustand: React.FC<HilModalZustandProps> = ({
  onSubmit,
  ...
  const { isHilModalOpen, hilContext, hilUserGuidance } = useUIStore(state => ({
    isHilModalOpen: state.isHilModalOpen,
    hilContext: state.hilContext,
    hilUserGuidance: state.hilUserGuidance
  }));
...
export default HilModalZustand;