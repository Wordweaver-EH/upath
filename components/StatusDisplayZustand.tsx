...
const StatusDisplayZustand: React.FC<StatusDisplayProps> = ({ formatElapsedTime }) => {
  ...
  return (
    <div className="p-4 bg-light-bg-alt dark:bg-dark-bg-alt rounded-lg shadow">
      ...
      {currentStepInfo.status === StepStatus.Loading && (
        <div className="mt-1 text-sm text-blue-600 dark:text-blue-400 animate-pulse">Processing...</div>
      )}
...
export default StatusDisplayZustand;