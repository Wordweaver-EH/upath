...
const App: React.FC = () => { 
  ...
  // Simple helper function to load step data for navigation
  const loadStepData = (stepIdToLoad: StepId, transcriptId?: string, phaseName?: string, gduId?: string): { inputData?: any, outputData?: any, error?: string, groundingSources?: any[] } => {
