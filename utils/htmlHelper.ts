...
table{border-collapse:collapse;width:100%;margin-bottom:20px;font-size:.9em;}th,td{border:1px solid var(--app-border);padding:8px;text-align:left;}th{background-color:var(--app-highlight-bg);}.iv-row{background-color:var(--app-subtle-bg);}.iv-row th{font-style:italic;font-size:0.8em;color:var(--app-accent-red);}.iv-cell{max-width:120px;word-wrap:break-word;}
