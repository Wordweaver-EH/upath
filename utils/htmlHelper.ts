...
// Traceability interfaces and functions have been moved to traceabilityHelper.ts
import { prepareAnnotationDataForTranscript, AnnotatedLine, ContributingP0_3UtteranceTrace } from './traceabilityHelper';
